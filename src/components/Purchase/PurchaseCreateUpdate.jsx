  ...
  const createNewSale = async () => {
    let reqBody = {
      Parent: {
        ...
        OtherCost: otherCostRef.value,
        ShippingCost: shippingCostRef.value,
        GrandTotal: grandTotalRef.value,
        Note: noteRef.value,
      },
      Childs: PurchaseItemList,
    };
    if (await CreatePurchaseRequest(reqBody)) {
              ...
              <div className="card-body">
                <div className="row">
                  ...
                  <div className="col-12 p-1">
                    ...
                    <input
                      ref={(input) => (shippingCostRef = input)}
                      className="form-control form-control-sm"
                      type="number"
                    />
                  </div>
